...
/**
 * Loads RSA public keys from X.509/SPKI PEM files with startup fail-fast. Order is a validator only
 * (never a signer), so no private key is ever loaded here. Every failure throws {@link
