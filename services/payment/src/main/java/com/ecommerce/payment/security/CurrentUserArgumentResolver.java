...
/**
 * Injects the authenticated {@link CurrentUser} into controller methods. Reached only on
 * authenticated requests — SecurityConfig rejects anonymous ones with 401 first.
 */
@Component
