 ...
 * context. The raw token is kept as authentication credentials so it can be forwarded to Order
 * Service on user-scoped calls. A missing or invalid token leaves the context unauthenticated.
 */
