...
/**
 * Loads RSA public keys from PEM files with startup fail-fast. Product is a validator only, so only
 * the X.509/SPKI public key is loaded (no private key). Every failure throws {@link
