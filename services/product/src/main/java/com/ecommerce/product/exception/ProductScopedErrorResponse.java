 ...
 * (contract: {@code INSUFFICIENT_STOCK} / {@code PRODUCT_NOT_FOUND}). Keeps the same shape as
 * {@link ErrorResponse}, adding one machine-readable field; never leaks internals.
 */
