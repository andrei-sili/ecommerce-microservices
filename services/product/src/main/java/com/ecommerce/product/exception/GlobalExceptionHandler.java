...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  /** Reservation failures name the offending product in the {@code product_id} field. */
  ...
  /**
   * Path-variable / query-param type mismatch → 400 MALFORMED_REQUEST. This exact subtype is NOT in
   * the base class's 20-type list (it maps the supertype {@code TypeMismatchException}), so a
   * standalone {@code @ExceptionHandler} for it does not collide — the more specific type wins at
   * resolution time and startup stays clean.
   */
